...
class Calibration():
    ...
    """
    def __init__ (self, sampling_frequency, cutoff_frequency, filter_order, calibration_pin_left,calibration_pin_right,static_gain,rmsfilter_window_size):
        ...
        self.mohpL = Multiorderhighpass(self.filter_order,self.sampling_frequency,self.cutoff_frequency,self.static_gain)
        self.rmsfL = Rmsfilter(self.rmsfilter_window_size)
        self.mohpR = Multiorderhighpass(self.filter_order,self.sampling_frequency,self.cutoff_frequency,self.static_gain)
    ...
    def get_calibration_result_left(self):
        return self.calibration_result_left 
    
    def get_calibration_result_right(self):
        return self.calibration_result_right