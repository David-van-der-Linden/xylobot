...
from states import States #states file
...
class NucleoButtonControl(object):
    ...
    def update_state(self):
        ...
        if self.is_pressed:
            ...
            if self.state_object.state is States.SAFE:
                self.state_object.set_state(States.READ)
            elif self.state_object.state is States.READ:
                self.state_object.set_state(States.ON)
            else:
                self.state_object.set_state(States.SAFE)
